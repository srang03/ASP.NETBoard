...
namespace MemoEngine.DotNetNote
{
    public partial class ImageText : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            objGraphics.DrawString(c1.ToString(), new Font("Verdana", 12, FontStyle.Bold),
                Brushes.DarkBlue, new PointF(5, 1));

            objGraphics.DrawString(c2.ToString(), new Font("Arial", 11, FontStyle.Bold),
          Brushes.DarkBlue, new PointF(25, 1));

            objGraphics.DrawString(c3.ToString(), new Font("Verdana", 11, FontStyle.Bold),
          Brushes.DarkBlue, new PointF(45, 1));

            objGraphics.DrawString(c4.ToString(), new Font("Arial", 12, FontStyle.Bold),
